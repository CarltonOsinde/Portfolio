            ...
            <Col md={4} sm={12}>
              <Row>
                <Col className="mb-2" sm={12}>
                  {roles && (
                    <motion.div variants={LeftRevealChild} className="mb-2">
                      <p className="font-weight-bold text-close sm">Position</p>
                ...
                <Col className="mb-2" sm={12}>
                  {tools && (
                    <motion.div variants={LeftRevealChild} className="mb-2">
                      <p className="font-weight-bold text-close sm">Tools Used</p>
                ...
                <Col className="mb-2" sm={12}>
                  {type && (
                    <motion.div variants={LeftRevealChild} className="mb-2">
                      <p className="font-weight-bold text-close sm">Employment Type</p>
                ...
                <Col className="mb-2" sm={12}>
                  {timeline && (
                    <motion.div variants={LeftRevealChild} className="mb-2">
                      <p className="font-weight-bold text-close sm">Location</p>
